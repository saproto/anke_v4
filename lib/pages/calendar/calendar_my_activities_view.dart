...
class CalendarMyActivitiesViewPage extends StatefulWidget{
  ...
  @override
  _CalendarMyActivitiesViewPageState createState() => _CalendarMyActivitiesViewPageState(this._futureActivity);
}

class _CalendarMyActivitiesViewPageState extends State<CalendarMyActivitiesViewPage> {
  Future<List<Activity>> _futureActivity;

  _CalendarMyActivitiesViewPageState(this._futureActivity);
  @override
  void initState(){
    super.initState();
